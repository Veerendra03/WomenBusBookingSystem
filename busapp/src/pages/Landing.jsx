    ...
    <div className="landing-container">
      ...
      <section className="about">
        ...
        <p>
          ...
          with a focus on customer satisfaction and convenience and more safe for Women with parental live notifications
        </p>
      </section>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-features">
            ...
            <ul>
              ...
              <li><ArrowRight className="footer-icon" /> parental notifications</li>
            </ul>
          </div>
        ...
        <p className="footer-copyright">support: contact.zesttravel@gmail.com</p>
        <div className="footer-copyright">
          <h3>Contact Us</h3>
          <a href="tel:+91 6309815125" className="footer-copyright">📞 +91 6309815125</a>
        </div>
      </footer>
